...
exports.postFile = function(connection, file, callback) {
	var xhr = new XMLHttpRequest();
    xhr.onload = requestComplete;
    xhr.open("POST", connection.host + API_PATH_PREFIX.concat("chatter/feeds/news/me/feed-items"), true);
    xhr.setRequestHeader('Authorization', 'Bearer ' + connection.access_token);
    ...
    body += 'Content-Type: image/png; charset=UTF-8\r\n\r\n';
